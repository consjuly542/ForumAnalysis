...
<body class="notebook_app "
    ...
    data-jupyter-api-token="29f24ffe4682ee0524acdf3cc0d0afe072308a757c7c8025"
  
 
data-base-url="/"
data-ws-url=""
data-notebook-name="Article%20%2B%20load_file.ipynb"
data-notebook-path="Article%20%2B%20load_file.ipynb"
...
<script type="text/javascript">
    sys_info = {"notebook_version": "5.0.0", "notebook_path": "C:\\ProgramData\\Anaconda3\\lib\\site-packages\\notebook", "commit_source": "", "commit_hash": "", "sys_version": "3.6.1 |Anaconda 4.4.0 (64-bit)| (default, May 11 2017, 13:25:24) [MSC v.1900 64 bit (AMD64)]", "sys_executable": "C:\\ProgramData\\Anaconda3\\python.exe", "sys_platform": "win32", "platform": "Windows-8.1-6.3.9600-SP0", "os_name": "nt", "default_encoding": "utf-8"};
</script>
