...
class StatisticsModule(object):
	...
	# 	self.cur_articles_list = self.article_index.values()
	# 	#ranking list of articles wuthout filters - for fast execution
	# 	self.articles_list_all = self.article_index.values()
	...
	# 	self.ranking_article(type = 'by_cnt_questions')
	...
	def ranking_article(self, rank_type = 'by_cnt_questions'):
	...
	def cancel_filter(self, filter_type):
		...
		self.cur_articles_list = self.articles_list_all
